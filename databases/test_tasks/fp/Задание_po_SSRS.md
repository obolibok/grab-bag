Проанализировать объекты  и разобраться со структурой БД.
![image](images/image_1.png)
Создать отчет, который бы показывал календарь доступности и загрузки ресурса на месяц в следующем виде (картинка только для примера как должен выглядеть календарь):
...
Данное задание позволит оценить следующие моменты:
